...
function showConsentModal() {
    ...
    var htmlString = '<!-- Modal -->'
        ...
        + '<button class="affirm btn btn-primary btn-style-css" data-url="' + urlAccept + '" autofocus data-dismiss="modal">'
        + textYes
        + '</button>'
        + '<button class="decline btn btn-primary btn-style-css" data-url="' + urlReject + '" data-dismiss="modal" >'
        + textNo
        + '</button>'
        + '</div>'
        + '</div>'
